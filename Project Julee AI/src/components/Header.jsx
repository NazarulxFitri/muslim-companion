...
export default function Header({ connectedIntegrations }) {
  return (
    <header style={{
      height: '64px',
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
        ...
        <div className="glass-pill" style={{ fontSize: '0.75rem', color: 'var(--primary-cyan)', display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <Activity size={13} color="var(--primary-cyan)" style={{ display: 'block' }} />
          </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <div className="glass-pill" style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <Globe size={14} color={connectedIntegrations.vercel ? 'var(--primary-cyan)' : 'var(--text-dim)'} style={{ display: 'block' }} />
          </div>
        ...
        {/* Server Status pill */}
        <div className="glass-pill" style={{ borderColor: 'rgba(139, 92, 246, 0.4)', background: 'rgba(139, 92, 246, 0.08)', display: 'inline-flex', alignItems: 'center', gap: '6px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <Server size={14} color="var(--primary-purple)" style={{ display: 'block' }} />
          </div>
